...
const EXPECTED_GATEWAY_ROUTES = [
  ...
  { method: "POST", path: "/v1/agents/sessions/{sessionId}/run" },
  { method: "POST", path: "/v1/agents/sessions/{sessionId}/stream" },
  ...
  { method: "POST", path: "/v1/query/ask/stream" },
  { method: "POST", path: "/v1/products/customer-gpt/chat" },
  { method: "POST", path: "/v1/products/customer-gpt/chat/stream" },
